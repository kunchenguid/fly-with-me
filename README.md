...
- The corner control opens a perch: a row of shapes to fly as, a gull, an eagle, a swallow, a crane or an owl, over a row of colors for the one you are flying, its own or one of sixteen plumages. The flock that joins now and then is the same bird, and the page remembers the one you chose.
