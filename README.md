...
- The corner control opens a perch where you can fly as another bird, a gull, an eagle, a swallow, a crane or an owl, each in its own colors or in one of sixteen plumages, and the flock that joins now and then is the same kind. The page remembers the one you chose.
